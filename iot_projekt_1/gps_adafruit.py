...
while True:
    try:
        ...
        #mqtt.web_print(gps_data, 'Andersschiller/feeds/mapfeed/csv')        
        #sleep(4) # vent mere end 3 sekunder mellem hver besked der sendes til adafruit
        
        #mqtt.web_print("Spillers position") # Hvis der ikke angives et 2. argument vil default feed være det fra credentials filen      
        sleep(4)  # vent mere end 3 sekunder mellem hver besked der sendes til adafruit
